...
#insight/2025/4/21 не все ссылки добавленные в документ одинаково видны для одного и того же режима работы с документом. Если ссылку добавить в документ внутрь комментрария примерно вот так   \%\% [[__README#title]]   \%\%  , то в режиме чтения ссылку видно не будет  %% [[__README]] %% , но в сайдбаре она будет видна
## subject
### synopsis
